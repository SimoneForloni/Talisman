...
public class SpaceFactory {
   ...
   */
  public static Space createRandomSpace(int id, game.service.factories.Deck deck) {
    ...
    if (roll < 40) {
      ...
      return new DrawCardSpace("Mysterious Woods " + id, "The shadows lengthen around you...", deck);
    } else if (roll < 90) {
